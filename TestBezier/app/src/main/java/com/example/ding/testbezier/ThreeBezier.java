...
public class ThreeBezier extends View {
    ...
    private int mScreenWidth=1020;
    private int mScreenHeight=1980;
    public ThreeBezier(Context context) {
        super(context);

    }

    public ThreeBezier(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ThreeBezier(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

    }

    public ThreeBezier(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
