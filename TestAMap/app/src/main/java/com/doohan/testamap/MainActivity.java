...
public class MainActivity extends AppCompatActivity implements AMapLocationListener,LocationSource,AMapNaviListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMap.setLocationSource(this);//设置了定位的监听
        // 是否显示定位按钮
