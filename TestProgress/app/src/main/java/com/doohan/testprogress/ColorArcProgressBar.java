...
public class ColorArcProgressBar extends View{
    ...
    private Paint progressPaintHead;
    private Paint vTextPaint;
    private Paint vTextPaint1;
    ...
    private void initView() {
        ...
        bgRect1.right = progressWidth*2 + (longdegree + progressWidth/2 + DEGREE_PROGRESS_DISTANCE);
        bgRect1.bottom =progressWidth*2 + (longdegree + progressWidth/2 + DEGREE_PROGRESS_DISTANCE);
        ...
        //当前进度的弧形的头部
        progressPaintHead = new Paint();
        progressPaintHead.setAntiAlias(true);
        progressPaintHead.setStyle(Paint.Style.STROKE);
        progressPaintHead.setStrokeCap(Paint.Cap.ROUND);
        progressPaintHead.setStrokeWidth(progressWidth);
       // progressPaintHead.setColor(Color.GREEN);
        progressPaintHead.setARGB(255,100,100,0);
       // progressPaintHead.setDither(true);
        ...
        vTextPaint1 = new Paint();
        vTextPaint1.setTextSize(textSize/3);
        vTextPaint1.setColor(Color.parseColor(hintColor));
        vTextPaint1.setTextAlign(Paint.Align.CENTER);
    ...
    protected void onDraw(Canvas canvas) {
      ...
      //  progressPaintHead.setShader(sweepGradient);
        //当前进度
       // canvas.drawArc(bgRect, startAngle, currentAngle, false, progressPaint);

        //当前进度的头部圈
      //  progressPaintHead.setAlpha((int) (255-maxValues+currentAngle));
       // progressPaintHead.setXfermode(new Xfermode());

        canvas.drawCircle((float) (diameter/2*Math.cos((currentAngle+startAngle)*3.14/180)+centerX), (float) (diameter/2*Math.sin((currentAngle+startAngle)*3.14/180)+centerY), progressWidth, progressPaintHead);
        ...
        if (isNeedContent) {
            ...
            canvas.drawText("%", centerX+80, centerY + textSize / 3, vTextPaint1);
        }
        if (isNeedUnit) {
