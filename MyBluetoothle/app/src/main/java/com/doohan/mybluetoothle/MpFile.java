...
public class MpFile {
    ...
    public  byte[] readFile() throws IOException {
        ...
        try{
            InputStream is =mContext.getAssets().open("IMIGO_audio.rmf");
    ...
    public   HashMap<Integer,byte[]> initData(byte[] filecontent) {
        ...
        byte[] bb=filecontent;
            ...
            for (int i = 0; i < a; i++) {
                ...
                System.arraycopy(bb, i * 128, buf, 0, 128);
            ...
            if (b > 0) {
                byte[] b1= new byte[b];
                System.arraycopy(bb, a * 128, b1, 0, b);
                map.put(a,b1);
