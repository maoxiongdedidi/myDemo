...
public class UpgradeActivity extends Activity {
    private final static String TAG = UpgradeActivity.class
            .getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button_send_value.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    map.clear();
                    FileUtils fileUtils = new FileUtils(UpgradeActivity.this);
        ...
        button_mp_calue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    map.clear();
                    MpFile fileUtils = new MpFile(UpgradeActivity.this);
                    byte[] s = fileUtils.readFile();
                    map= fileUtils.initData(s);
            ...
            if (substring.length() > 8) {
                ...
                switch (substring1) {
                    ...
                    case "2301":
                        ...
                        Toast.makeText(UpgradeActivity.this,"升级成功",Toast.LENGTH_SHORT).show();
                        button_mp_calue.setEnabled(true);
                        button_send_value.setEnabled(true);
                        break;
                    case "2401":
    ...
    Runnable mRunnable3= new Runnable() {
        ...
        public void run() {
            ...
            mBluetoothLeService.writeLlsAlertLevel(2, bb);
            mHandler.postDelayed(mRunnable3,5000);
            Toast.makeText(UpgradeActivity.this, "重发",
